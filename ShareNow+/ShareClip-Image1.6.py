...
def get_clipboard_content():
    ...
    if os.getenv('WAYLAND_DISPLAY') or os.getenv('XDG_SESSION_TYPE') == 'wayland':
        ...
        if not image_data_found and not detected_content.get('image_svg_base64') and image_access_errors:
             detected_content['image_error'] = "No convertible image found or errors occurred: " + "; ".join(set(image_access_errors)) 
        elif not image_data_found and not detected_content.get('image_svg_base64'):
...
<div id="container">
    <h2>ShareNow - Type C v1.9 (Text, HTML, Image Clipboard)</h2>
    <div id="pathbar">
    ...
    <div class="section" id="clipboard-section">
        <div id="clipboard-header">
            ...
            {# "Refresh Clipboard" button is always displayed now #}
