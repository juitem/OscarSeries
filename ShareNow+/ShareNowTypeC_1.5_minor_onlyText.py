...
import logging
import argparse
import pyperclip # We will rely solely on pyperclip for text clipboard
# from PIL import Image # No longer needed if not handling images
# import io # No longer needed if not handling images
import base64
# import pyclip # Not used anymore
import json
...
@app.route('/')
def index():
    # clipboard_data will now only contain 'text_plain' or be empty
    clipboard_data = {} 
...
#clipboard-content img { /* This style is still here but img won't be displayed from server clipboard */
    max-width: 100%; 
    height: auto;
    display: block; 
    margin: 5px 0;
...
<div id="container">
    ...
    <div class="section" id="clipboard-section">
        ...
        <div id="clipboard-content">
            {% if clipboard_data %} 
                {# Removed image_png_base64 and text_html sections as pyclip is removed #}
